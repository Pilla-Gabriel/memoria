const STATUS_STYLE: Record<string, { label: string; bg: string; fg: string }> = {
  ...
  ATINGIDA: { label: "Atingida", bg: "rgba(34,197,94,0.12)", fg: "var(--badge-success-fg)" },
  EM_RISCO: { label: "Em risco", bg: "rgba(245,158,11,0.12)", fg: "var(--badge-warning-fg)" },
  VENCIDA: { label: "Vencida", bg: "rgba(239,68,68,0.12)", fg: "var(--badge-danger-fg)" },
